            ...
            <Component>
                <Carousel responsive={responsive}
                    ...
                    slidesToSlide={1}>
                    {
                        movies.map(movie => (
                            <>
                                <StyledBanner src={`http://image.tmdb.org/t/p/original/${movie.backdrop_path}`} alt="bannner" />
                ...
                <Container>
                    ...
                    <Typography style={{fontSize:12, margin:5}}>IMDb Top {movies.length} as rated  by regular IMDb viewers.</Typography>
                    <Divider/>
